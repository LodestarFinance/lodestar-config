...
This repository contains all configuration for the Lodestar Protocol on Ethereum. Projects wishing to interact with Lodestar contracts will be able to find contract addresses, ABIs and interfaces for the core Lodestar contracts in this repo.
